...
class AppColors {
  static const Color primaryColor = Color(0xFF2E4192);
  static Color secondaryColor = const Color(0xFFb9bfda);
  static Color shadowColor = const Color(0xFF36B4E7);
  static Color captionColor = const Color(0xFF6b6b6b);
  static Color secondaryButtonColor = const Color(0xFFdbddeb);
  static const Color whiteColor = Color(0xFFFFFFFF);
  static const Color blackColor = Color(0xFF000000);
  static const Color greenColor = Color(0xFF28b889);
